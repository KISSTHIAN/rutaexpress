...
module.exports = [
    ...
    {
        id: 'metodos_pago',
        palabras_clave: ['como pago', 'formas de pago', 'yape', 'plin', 'metodos de pago', 'puedo pagar con'],
        respuesta: 'Puedes registrar tus billeteras digitales (Yape, Plin u otras) en la sección "Métodos de Pago" de tu panel. El cobro/pago final se coordina directamente con el conductor.'
    },
    {
        id: 'cancelar_pedido',
